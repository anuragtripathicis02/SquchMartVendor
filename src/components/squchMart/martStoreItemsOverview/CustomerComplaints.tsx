    ...
    <div className='top-menu-sec card-box p-16 h-100 d-flex flex-column'>
        <div className='top-box'>
            ...
            <div className='table-sec'>
                <table width='100%'>
                    <tr>
                        <td className='ps-0'>Wrong items deliverd</td>
                        <td className='text-end pe-0'>01</td>
                    </tr>
                    <tr>
                        <td className='ps-0'>Missing items</td>
                        <td className='text-end pe-0'>02</td>
                    </tr>
                    <tr>
                        <td className='ps-0'>Poor taste/quality</td>
                        <td className='text-end pe-0'>01</td>
                    </tr>
                </table>
            </div>
