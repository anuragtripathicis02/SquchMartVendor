...
const MartStoreOrderRejectModal = ({ show, handleClose, onFinalClose }: any) => {
              ...
              <div className="col-md-12">
                ...
                <div className="checkbox-inline">
                  ...
                  <div className="customise-status">
                    <Form.Check type="checkbox" id="custom-switch5" label="Mart closure"/>
                  </div>
                  <div className="customise-status">
...
export default MartStoreOrderRejectModal;
