...
const MartStoreOrderConfirmationModal = ({ show, handleClose }: any) => {
            ...
            <Modal show={show && !showDetailsModal} onHide={handleCloseAll} centered className="host-profile-modal common-modal-sec modal-small-box pt-4">
                <Modal.Body className="common-modal-body p-0 text-center pt-2">
                    ...
                    <div className='text-box'>
                        <h5 className='font-text mb-2'>Order (#1259) has been confirmed.</h5>
                        <p>Your order ( #1259) has been successfully placed. You will receive a confirmation shortly.</p>
             ...
             <Modal.Footer className="footer-step-form modal-footer-box d-flex align-items-center gap-2 justify-content-end">
                    
                    <div className='btn-right-footer-box d-flex align-items-center  gap-2'>                        
                        <button className='btn btn-secondary m-0' onClick={handleOrderDetails}>
                           Order Details
                        </button>
                    </div>
                </Modal.Footer>
...
export default MartStoreOrderConfirmationModal