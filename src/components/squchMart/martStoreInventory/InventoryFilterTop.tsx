...
const InventoryFilterTop = () => {
        const [showInventoryDetails, setShowInventoryItems] = useState(false);
            ...
            <div className='right-box d-flex align-items-center gap-xl-3 gap-1'>
             ...
             <div className='left-box d-flex align-items-center gap-xl-3 gap-1 flex-wrap'>
                ...
                <Link href="" className='btn btn-white  d-flex align-items-center gap-1'>
                  ...
                  <Link href="" className='btn btn-secondary d-flex align-items-center gap-1' onClick={setShowInventoryItems}>
 ...
 <InventoryItemDetailsModal show={showInventoryDetails} handleClose={handleCloseAll} />
    </div>
  )
}

export default InventoryFilterTop;