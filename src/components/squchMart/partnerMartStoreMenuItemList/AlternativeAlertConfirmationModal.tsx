...
const AlternativeAlertConfirmationModal = ({ show, handleClose }: any) => {
  ...
  return (
    <>
        <Modal show={show && !showDetailsModal} onHide={handleCloseAll} centered className="host-profile-modal common-modal-sec modal-small-box pt-4">
            <Modal.Body className="common-modal-body p-0 text-center pt-5 pb-5">
                <div className='modal-box p-3'>
                    ...
                    <div className='text-box'>
                        <h5 className='font-text mb-2'>Alternative option send to customer</h5>
                        <p>This order will be updated shortly</p>
                    </div>
                </div>
            </Modal.Body>
        </Modal>
...
export default AlternativeAlertConfirmationModal