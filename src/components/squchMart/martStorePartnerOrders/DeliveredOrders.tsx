            ...
            <div className="order-slider-box card-box p-16">
                  ...
                  <div className="dropdown-sec">
                    <Dropdown>
                      ...
                      <Dropdown.Menu align="end" className="pt-2 pb-2">
                        ...
                        <Dropdown.Item
                          href="#/action-3"
                          className="btn-active-red d-flex align-items-center gap-2"
                        >
                          <span>Delivered</span>
                        </Dropdown.Item>
                        <Dropdown.Item
              ...
              <div className="total-bill d-flex align-items-center justify-content-between gap-2">
                <div className="price-box d-flex align-items-center gap-2">
                  Total bill : <span>₵32.00</span>{" "}
                  <span className="text-green">Paid</span>
                </div>
                <Link
                  className="btn-more d-flex align-items-center gap-2"
                  href=""
                >
                  <svg
                    width="16"
                  ...
                  <ul className="d-flex align-items-center gap-2">
                    ...
                    <li>
                      <Link href="">
                        ...
                        >
                          <path
                            d="M0.666992 4C0.666992 1.79086 2.45785 0 4.66699 0H20.667C22.8761 0 24.667 1.79086 24.667 4V20C24.667 22.2091 22.8761 24 20.667 24H4.66699C2.45785 24 0.666992 22.2091 0.666992 20V4Z"
                            fill="#3D3D3D"
                          />
                          <path
                            d="M10.3333 16.6663H10C7.33333 16.6663 6 15.9997 6 12.6663V9.33301C6 6.66634 7.33333 5.33301 10 5.33301L15.3333 5.33301C18 5.33301 19.3333 6.66634 19.3333 9.33301V12.6663C19.3333 15.333 18 16.6663 15.3333 16.6663H15C14.7933 16.6663 14.5933 16.7663 14.4667 16.933L13.4667 18.2663C13.0267 18.853 12.3067 18.853 11.8667 18.2663L10.8667 16.933C10.76 16.7863 10.5133 16.6663 10.3333 16.6663Z"
                            stroke="white"
                            stroke-miterlimit="10"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M9.33398 9.33301L16.0007 9.33301"
                            stroke="white"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                          <path
                            d="M9.33398 12.667H13.334"
                            stroke="white"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                ...
                <div className="top-admin-contact d-flex align-items-center gap-2 justify-content-between">
                  ...
                  <ul className="d-flex align-items-center gap-2 m-0">
                    <li className="d-flex align-items-center gap-2 text-black fw-bold">
                      ...
                      >
                        <path
                          d="M9.48628 2.34074L10.6596 4.68741C10.8196 5.01408 11.2463 5.32741 11.6063 5.38741L13.7329 5.74074C15.0929 5.96741 15.4129 6.95408 14.4329 7.92741L12.7796 9.58074C12.4996 9.86074 12.3463 10.4007 12.4329 10.7874L12.9063 12.8341C13.2796 14.4541 12.4196 15.0807 10.9863 14.2341L8.99295 13.0541C8.63295 12.8407 8.03961 12.8407 7.67295 13.0541L5.67961 14.2341C4.25295 15.0807 3.38628 14.4474 3.75961 12.8341L4.23295 10.7874C4.31961 10.4007 4.16628 9.86074 3.88628 9.58074L2.23295 7.92741C1.25961 6.95408 1.57295 5.96741 2.93295 5.74074L5.05961 5.38741C5.41295 5.32741 5.83961 5.01408 5.99961 4.68741L7.17295 2.34074C7.81295 1.06741 8.85295 1.06741 9.48628 2.34074Z"
                          fill="#3D3D3D"
                        />
                      </svg>{" "}
                      4.2
