    ...
    <div className="operator-list-main mt-4">
      <div className="opretator-box inventory-box card-box d-flex align-items-center  flex-wrap justify-content-between mb-3">
        ...
        <div className="text-operator d-flex align-items-center justify-content-between ">
          ...
          <div className="text-box ">
            <span>Status</span>
            <Link href="" className="Active btn-small text-center mt-0">
              Available
            </Link>
          </div>
        </div>
      ...
      <div className="opretator-box inventory-box card-box d-flex align-items-center  flex-wrap justify-content-between mb-3">
        ...
        <div className="text-operator d-flex align-items-center justify-content-between">
          ...
          <div className="text-box ">
            <span>Status</span>
            <Link href="" className="btn-small In-complete text-center ">
              About to expire
            </Link>
          </div>
        </div>
      ...
      <div className="opretator-box inventory-box card-box d-flex align-items-center  flex-wrap justify-content-between mb-3">
        ...
        <div className="text-operator d-flex align-items-center justify-content-between">
          ...
          <div className="text-box ">
            <span>Status</span> 
            <Link href="" className="btn-danger btn-small text-center mt-0">
              Expired
            </Link>
          </div>
        </div>
      ...
      <div className="opretator-box inventory-box card-box d-flex align-items-center  flex-wrap justify-content-between mb-3">
        ...
        <div className="text-operator d-flex align-items-center justify-content-between">
          ...
          <div className="text-box  ">
            <span>Status</span>
            <Link href="" className="btn-small stockout text-center mt-0">
              Low on stock
            </Link>
          </div>
        </div>
