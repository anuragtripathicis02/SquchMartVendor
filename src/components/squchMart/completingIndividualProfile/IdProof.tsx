      ...
      <Form>
        <div className='row'>
          <div className='col-md-12'>
            <div className='heading-profile-box mb-24'>
                <h6>Let's secure your account with ID verification</h6>
                <p className='m-0 p-0 pt-2'>Protecting your account starts with verifying your identity. A valid ID helps ensure your safety and builds trust within our community. </p>
            </div>
          </div>
          <div className='col-md-12'>
              <div className="form-group mb-24">
                  <Form.Label >User Id Number</Form.Label>
                  <Form.Control type="text" placeholder='12345678902346' />
              </div>
          </div>  
          <div className='col-md-12'>
            <div className="form-group mb-24">
