...
const RestaurantDocumentation : React.FC<Props> = ({ handleFinalSubmit }) => {
  ...
  return (
    <div className="card-box profile-availability p-16">
    <Form>
        <div className='row'>
            <div className='col-md-6'>

                <div className="form-group mb-24 ">
                    <Form.Label>Business Registration Permit</Form.Label>
                    <div
