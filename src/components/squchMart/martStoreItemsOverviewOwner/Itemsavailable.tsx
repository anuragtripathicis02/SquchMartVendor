    ...
    <div className="items-available-sec  card-box p-16">
      <div className="row">
        <div className="col-md-12 mb-3">
          <h2 className="mb-2">Items available on</h2>
        </div>
